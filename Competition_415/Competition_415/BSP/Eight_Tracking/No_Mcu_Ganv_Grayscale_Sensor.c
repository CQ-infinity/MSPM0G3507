...
void Get_Analog_value(unsigned short *result)        //模拟信号采集和滤波
{
    unsigned char i,j;
...
{     //传感器初始化，根据Calibrated_black和Calibrated_black来计算出最后区分黑白的阈值
    
    No_MCU_Ganv_Sensor_Init_Frist(sensor);   //先清零所有参数
